...
const RegisterModal = () => {
  ...
  const {
    register,
    handleSubmit,
    formState: { errors } = { errors: {} }, // add an initializer for errors
  } = useForm<FieldValues>({
    defaultValues: {
      name: "",
      email: "",
  ...
  const footerContent = (
    <div className="flex flex-col gap-4 mt-3">
      ...
      <div className="text-neutral-500 text-center mt-4 font-light">
        <div className="justify-center flex-row flex items-center gap-2">
          <p>Already Have an Account?</p>
          <p onClick={registerModal.onClose} className="text-neutral-800 cursor-pointer hover:underline">
            Log in
          </p>
        </div>
      </div>
